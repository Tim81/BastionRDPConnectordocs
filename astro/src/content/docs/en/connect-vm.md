...
<figure class="appshot">
  <div class="frame">
    <svg viewBox="0 0 300 372" role="img" aria-labelledby="s-vm-win">
      ...
      <text class="ui-tb" x="167" y="141">This subscription</text>
...
| Mode | Behaviour |
| --- | --- |
| This subscription (default) | Lists every VM in the selected subscription right away. Type in the filter box to narrow it by name. The subscription dropdown only shows subscriptions that actually contain VMs. |
